#!/usr/bin/ruby
#
# This file is licensed under a Creative Commons Share Alike-Attribution 
# 3.0 License.  For attribution of this work, link to the 2 pages below and
# include my name, Douglas P Perkins.
...
if actions == 1
	...
	puts 'Error: No deck specified.  Use --grade, --jlpt, or --all.'
end
